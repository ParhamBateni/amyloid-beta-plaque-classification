...
class BaseClassifier(ABC, nn.Module):
    ...
    @staticmethod
    def create_classifier(classifier_name: str, input_size: int, output_size: int, classifier_config: dict) -> "BaseClassifier":
        full_cfg = {"input_size": input_size, "output_size": output_size, **classifier_config}
